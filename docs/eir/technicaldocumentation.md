...
| fld_Occurred_Date                          | Injury Occurred:                                             | calendar entry                                               |
| fld_Occurred_Time                          | Injury Occurred:                                             | clock entry                                                  |
| fld_NotifiedSupervisor_Date                | Supervisor Notified:                                         | calendar entry                                               |
| fld_NotifiedSupervisor_Time                | Supervisor Notified Name:                                    | clock entry                                                  |
...
| fld_Facility                               | Where incident occurred:                                     | ORMC \| APH \| 110 Building                                  |
...
| fld_Sharp_BbPathogen                       | Injury included exposure to bloodborne pathogen?             | Yes                                                          |
...
| fld_Sharp_OriginalUser                     | Was the injured worker the original user of the sharp item?  | Yes                                                          |
